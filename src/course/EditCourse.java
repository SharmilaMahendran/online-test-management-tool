...
public class EditCourse extends JPanel implements ItemListener{
	...
	public EditCourse(String courseName) {
		...
		updateEachMark.setFont(new Font("Times New Roman", Font.BOLD, 19));
		...
		chckbxHide.setFont(new Font("Times New Roman", Font.BOLD, 18));
	...
	private JPanel New()
	{
		...
		No1 = new JTextField();
		No1.setFont(new Font("Times New Roman", Font.BOLD, 12));
		No1.setBounds(154, 231, 560, 20);
		New.add(No1);
		
		No2 = new JTextField();
		No2.setFont(new Font("Times New Roman", Font.BOLD, 12));
		No2.setBounds(154, 269, 560, 20);
		New.add(No2);
		
		No3 = new JTextField();
		No3.setFont(new Font("Times New Roman", Font.BOLD, 12));
		No3.setBounds(154, 298, 560, 20);
		New.add(No3);
		
		No4 = new JTextField();
		No4.setFont(new Font("Times New Roman", Font.BOLD, 12));
	...
	private JPanel View()
	{
		...
		VcorrectOptionLabel.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		...
		VqStatement.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		Vo1 = new JTextField();
		Vo1.setFont(new Font("Times New Roman", Font.BOLD, 12));
		Vo1.setBounds(156, 232, 560, 20);
		View.add(Vo1);
		
		Vo2 = new JTextField();
		Vo2.setFont(new Font("Times New Roman", Font.BOLD, 12));
		Vo2.setBounds(156, 270, 560, 20);
		View.add(Vo2);
		
		Vo3 = new JTextField();
		Vo3.setFont(new Font("Times New Roman", Font.BOLD, 12));
		Vo3.setBounds(156, 299, 560, 20);
		View.add(Vo3);
		
		Vo4 = new JTextField();
		Vo4.setFont(new Font("Times New Roman", Font.BOLD, 12));
	...
	private JPanel Update()
	{
		...
		UqStatement.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		Uo1 = new JTextField();
		Uo1.setFont(new Font("Times New Roman", Font.BOLD, 12));
		...
		Uo2 = new JTextField();
		Uo2.setFont(new Font("Times New Roman", Font.BOLD, 12));
		...
		Uo3 = new JTextField();
		Uo3.setFont(new Font("Times New Roman", Font.BOLD, 12));
		...
		Uo4 = new JTextField();
		Uo4.setFont(new Font("Times New Roman", Font.BOLD, 12));
		...
		UcorrectOptionS.setFont(new Font("Times New Roman", Font.PLAIN, 13));
	...
	private JPanel Remove()
	{
		...
		RcorrectOptionLabel.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		...
		RqStatement.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		Ro1 = new JTextField();
		Ro1.setFont(new Font("Times New Roman", Font.BOLD, 12));
		Ro1.setBounds(158, 232, 560, 20);
		Remove.add(Ro1);
		
		Ro2 = new JTextField();
		Ro2.setFont(new Font("Times New Roman", Font.BOLD, 12));
		Ro2.setBounds(158, 270, 560, 20);
		Remove.add(Ro2);
		
		Ro3 = new JTextField();
		Ro3.setFont(new Font("Times New Roman", Font.BOLD, 12));
		Ro3.setBounds(158, 299, 560, 20);
		Remove.add(Ro3);
		
		Ro4 = new JTextField();
		Ro4.setFont(new Font("Times New Roman", Font.BOLD, 12));
