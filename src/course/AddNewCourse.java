...
public class AddNewCourse extends JPanel implements FocusListener {
	...
	public AddNewCourse() {
		...
		SS.setText("SECOND");
		SS.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		SS.setColumns(10);
		...
		MM.setText("MINUTE");
		MM.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		MM.setColumns(10);
		...
		HH.setText("HOUR");
		HH.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		HH.setColumns(10);
		...
		btnShowCourse.setFont(new Font("Times New Roman", Font.BOLD, 18));
	...
	public void focusLost(FocusEvent arg0) {
		...
		{
			courseName.setForeground(Color.LIGHT_GRAY);
			courseName.setFont(new Font("Times New Roman", Font.PLAIN, 18));
			courseName.setText("COURSE NAME");
		}
	}
}
