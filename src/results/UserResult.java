	...
	private void fetchData()
	{
		...
		try{
			...
			for(int i=0;i<totalTest;i++)
			{
				if(temp1.next())
				{
					DATA[i][0]=temp1.getString("Course Name");
					DATA[i][1]=temp1.getString("TotaL Questions");
					DATA[i][2]=temp1.getString("Attempted Question");
					DATA[i][3]=""+(temp1.getInt("Attempted Question")-temp1.getInt("Wrong Question"))+"";//correct questions
					DATA[i][4]=temp1.getString("Wrong Question");
					DATA[i][5]=temp1.getString("Total Marks");
					DATA[i][6]=temp1.getString("Obtained Marks");
					DATA[i][7]=temp1.getString("Percentage");
					DATA[i][8]=temp1.getString("Time taken");
					DATA[i][9]=temp1.getString("Test Date");
				}
			}
		}
