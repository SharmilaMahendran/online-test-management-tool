...
public class Panel1 extends JPanel {
	...
	public Panel1() {
		...
		lblOnlineExamination.setForeground(new Color(184,198,184));
		...
		JLabel lblSystem = new JLabel("PORTAL");
		lblSystem.setForeground(new Color(184,198,184));
		lblSystem.setBackground(new Color(220, 20, 60));
		lblSystem.setHorizontalAlignment(SwingConstants.CENTER);
		lblSystem.setFont(new Font("Times New Roman", Font.BOLD, 41));
