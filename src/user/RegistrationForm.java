...
public class RegistrationForm extends JPanel implements ActionListener {
	...
	public RegistrationForm() {
		...
		COLLEGE.setFont(new Font("Times New Roman", Font.BOLD, 14));
		...
		lblCollege.setFont(new Font("Times New Roman", Font.BOLD, 13));
		...
		Month=01;
		month.setFont(new Font("Times New Roman", Font.BOLD, 14));
		...
		other.setFont(new Font("Times New Roman", Font.BOLD, 13));
		...
		female.setFont(new Font("Times New Roman", Font.BOLD, 13));
		female.setBounds(338, 193, 73, 23);
		add(female);
		female.addActionListener(this);
		
		JRadioButton male = new JRadioButton("MALE");
		male.setFont(new Font("Times New Roman", Font.BOLD, 13));
		...
		LAST = new JTextField("");
		LAST.setFont(new Font("Times New Roman", Font.BOLD, 14));
		LAST.setColumns(10);
		LAST.setBounds(528, 157, 116, 20);
		add(LAST);
		
		MIDDLE = new JTextField("");
		MIDDLE.setFont(new Font("Times New Roman", Font.BOLD, 14));
		MIDDLE.setColumns(10);
		MIDDLE.setBounds(402, 157, 116, 20);
		add(MIDDLE);
		
		FIRST = new JTextField("");
		FIRST.setFont(new Font("Times New Roman", Font.BOLD, 14));
		FIRST.setColumns(10);
	...
	public RegistrationForm(EditDetails e) {
		...
		lblRegDate.setFont(new Font("Times New Roman", Font.BOLD, 13));
		...
		lblRegNo.setFont(new Font("Times New Roman", Font.BOLD, 13));
		lblRegNo.setBounds(58, 90, 97, 26);
		add(lblRegNo);
		submit.setForeground(new Color(50, 205, 50));
		submit.setFont(new Font("Times New Roman", Font.ITALIC, 32));
