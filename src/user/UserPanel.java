...
public class UserPanel extends JPanel {
	...
	public UserPanel(String username) {
		...
		btnResult.setFont(new Font("Times New Roman", Font.BOLD, 18));
		...
		btnStartTest.setFont(new Font("Times New Roman", Font.BOLD, 18));
		...
		lblSelectCourse.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		btnEditDetails.setFont(new Font("Times New Roman", Font.BOLD, 18));
		...
		WlecomeLabel.setFont(new Font("Times New Roman", Font.BOLD, 21));
